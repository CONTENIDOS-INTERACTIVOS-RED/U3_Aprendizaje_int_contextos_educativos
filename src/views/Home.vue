        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 3 del curso “Aprendizaje Integral y Cognición en Contextos Educativos” presenta estrategias para potenciar el aprendizaje y desarrollo cognitivo desde una perspectiva neuroeducativa, inclusiva y activa. Se abordan tres ejes fundamentales: las estrategias metacognitivas, técnicas didácticas basadas en la neurociencia y modelos de intervención psicopedagógica. Estos enfoques promueven la autorregulación, el pensamiento crítico y la motivación del estudiante, considerando sus contextos emocionales y sociales. La unidad enfatiza la planificación, el monitoreo y la evaluación del aprendizaje para construir propuestas educativas reflexivas, flexibles y contextualizadas.
